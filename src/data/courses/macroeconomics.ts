...
Aggregate demand shows total spending at different price levels. AD = C + I + G + (X - M). The AD curve slopes downward due to wealth, interest rate, and foreign trade effects. The curve shifts when consumption, investment, government spending, or net exports change for reasons other than price level.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-3-1-1',
            question: 'When the price level increases, the amount of goods and services demanded economy-wide decreases because when the price level increases, everyone\'s assets can purchase fewer goods and services. What is the term for the relationship described above?',
            options: [
            ...
            correctAnswer: 3,
            explanation: 'The real wealth effect describes how an increase in the price level decreases the real value of assets, leading to a decrease in demand for goods and services economy-wide.',
          },
          {
            id: 'quiz-3-1-2',
            question: 'Which of the following could cause the change shown?',
            options: [
              'A decrease in the price level in the United States',
              'A decrease in investment spending in the United States',
              'A decrease in government spending in the United States',
            ...
            correctAnswer: 4,
            explanation: 'An increase in national income in a trading partner increases exports, which causes the aggregate demand (AD) curve to shift to the right.',
          },
          {
            id: 'quiz-3-1-3',
            question: 'Which of the following is not a component of aggregate demand (AD)?',
            options: [
              'Government spending',
              'Consumption',
              'Net exports',
            ...
            correctAnswer: 4,
            explanation: 'Aggregate demand (AD) consists of consumption (C), investment (I), government spending (G), and net exports (X - M). Wages are not a component of AD, but rather a cost of production.',
          },
          {
            id: 'quiz-3-1-4',
            question: 'When the price level increases, goods in other countries are relatively cheaper. As a result, a country\'s imports increase, displacing the demand for domestic production. What is the term for the relationship described above?',
            options: [
              'Sticky wage theory',
              'Misperceptions theory',
              'The exchange rate effect',
            ...
            correctAnswer: 2,
            explanation: 'The exchange rate effect describes how changes in the price level affect international competitiveness and foreign trade, which in turn affects aggregate demand.',
          },
        ],
      } as QuizContent,
    ],
...
MPC is the fraction of additional income spent. The spending multiplier = 1 / (1 - MPC) shows how initial spending changes are amplified. The tax multiplier = -MPC / (1 - MPC) is smaller and negative. Multipliers explain how small policy changes can have large economic effects.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-3-2-1',
            question: 'The marginal propensity to consume (MPC) in Hamsterville is 0.75. What will be the size of the change in aggregate demand that will occur as a result of a $1 million dollar increase in the government spending component of AD?',
            options: [
              '$0.75 million',
              '$4 million',
              '$0.25 million',
            ...
            correctAnswer: 1,
            explanation: 'The spending multiplier = 1 / (1 - MPC) = 1 / (1 - 0.75) = 1 / 0.25 = 4. A $1 million increase in government spending will lead to a change in aggregate demand of 4 × $1 million = $4 million.',
          },
          {
            id: 'quiz-3-2-2',
            question: 'Fred got a year-end bonus in two different years. The table below describes how much of that bonus he spent in each year. Year 1: Bonus = $1000, Amount spent = $750. Year 2: Bonus = $2000, Amount spent = $1500. If Fred\'s habits represent the typical household in this country, what is the marginal propensity to save in this country?',
            options: ['3', '0.25', '1.33', '0.75', '250'],
            correctAnswer: 1,
            explanation: 'Change in bonus (income) = $2000 - $1000 = $1000. Change in amount spent (consumption) = $1500 - $750 = $750. Change in saving = $1000 - $750 = $250. Marginal propensity to save (MPS) = Change in saving / Change in income = $250 / $1000 = 0.25.',
          },
          {
            id: 'quiz-3-2-3',
            question: 'Which of the following best describes the purpose of the expenditure multiplier?',
            options: [
              'quantify the size of the change in aggregate demand (AD) that occurs as a result of a change in taxes',
              'quantify the size of the change in aggregate demand (AD) that occurs as a result of a change in a component of AD',
              'quantify the change in the size of the money supply that occurs as a result of a change in the reserve ratio',
              'quantify the change in aggregate demand (AD) that will occur as a result of a change in government spending, but not other components of AD',
              'quantify the change in the interest rate that will occur as a result of an increase deficit spending',
            ],
            correctAnswer: 1,
            explanation: 'The expenditure multiplier serves to quantify the size of the change in aggregate demand (AD) that occurs as a result of a change in any component of AD (consumption, investment, government spending, or net exports).',
          },
          {
            id: 'quiz-3-2-4',
            question: 'The nation of Johnsrudia has a marginal propensity to consume (MPC) of 0.9. If there is an autonomous increase in new home construction of $10 billion, what will happen to real gross domestic product (GDP)?',
            options: [
              'Real GDP will increase by exactly $10 billion',
              'Real GDP will increase by exactly $9 billion',
              'Real GDP will not change',
              'Real GDP will increase by less than $9 billion',
              'Real GDP will increase by more than $10 billion',
            ],
            correctAnswer: 4,
            explanation: 'The multiplier = 1 / (1 - MPC) = 1 / (1 - 0.9) = 1 / 0.1 = 10. An autonomous increase in new home construction (investment) of $10 billion will lead to a change in Real GDP = Multiplier × Change in Investment = 10 × $10 billion = $100 billion. Real GDP will increase by more than $10 billion.',
          },
        ],
      } as QuizContent,
    ],
...
The SRAS curve slopes upward because wages and prices are sticky in the short run. Higher price levels increase production when costs haven't fully adjusted. SRAS shifts when input prices, productivity, technology, or supply shocks change.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-3-3-1',
            question: 'Which of the following best describes why the short-run aggregate supply (SRAS) curve is upward sloping?',
            options: [
              ...
              'Firms respond to inflation by producing less',
              'Business spending on new capital will increase when the price level decreases',
            ],
            correctAnswer: 1,
            explanation: 'The short-run aggregate supply (SRAS) curve is upward sloping because prices and nominal wages are slow to adjust to changes in the price level. In the short run, nominal wages are often fixed by contracts, and other input prices are sticky. When the aggregate price level rises, firms\' revenues increase, but their production costs (like nominal wages) do not immediately rise proportionally. This creates higher profits per unit, incentivizing firms to increase output. Conversely, when the price level falls, revenues decrease but sticky costs remain, leading to lower profits and reduced output. This stickiness of wages and prices is the fundamental reason for the upward slope of the SRAS curve.',
          },
          {
            id: 'quiz-3-3-2',
            question: 'Which of the following types of events shifts the short-run aggregate supply (SRAS) curve to the right?',
            options: [
              'Any event that causes consumers to purchase fewer goods and services that is not due to changes in the price level',
              'Any event that makes it more expensive or more difficult to produce goods and services',
              'Any event that causes exports to decrease that is not due to changes in the price level',
            ...
            correctAnswer: 3,
            explanation: 'The short-run aggregate supply (SRAS) curve shifts to the right when any event makes it less expensive or easier to produce goods and services. This includes events such as: decreases in input prices (wages, raw materials, energy), increases in productivity, technological improvements, favorable supply shocks, or reductions in business taxes or regulations. A rightward shift of SRAS means that at any given price level, firms are willing to produce more output. Events that affect consumer demand or exports shift the aggregate demand curve, not the SRAS curve. An increase in the price level causes movement along the SRAS curve, not a shift.',
          },
          {
            id: 'quiz-3-3-3',
            question: 'What happens to inflation and unemployment as you move to the left along the short-run aggregate supply (SRAS) curve?',
            options: [
              'Inflation increases and unemployment decreases.',
              'Inflation doesn\'t change and unemployment doesn\'t change.',
              'Inflation decreases and unemployment increases.',
              'Inflation decreases and unemployment doesn\'t change.',
              'Inflation increases and unemployment doesn\'t change.',
            ],
            correctAnswer: 2,
            explanation: 'As you move to the left along the short-run aggregate supply (SRAS) curve, inflation decreases and unemployment increases. Moving left along the SRAS curve means moving to a lower price level and lower output. A lower price level means lower inflation (or deflation). Lower output means firms are producing less, which requires fewer workers, leading to higher unemployment. The SRAS curve shows the relationship between the price level and output: lower price levels are associated with lower output, and lower output is associated with higher unemployment.',
          },
        ],
      } as QuizContent,
    ],
...
The LRAS curve is vertical at potential GDP because in the long run, all prices adjust and output depends only on available resources. LRAS represents the economy's productive capacity. It shifts when resources, technology, or institutions change.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-3-4-1',
            question: 'Which of the following statements makes a correct distinction between the short run and the long run?',
            options: [
              'Short run: wages are fixed; long run: wages are fully flexible',
              'Short run: wages are fully flexible; long run: wages are fixed',
              'Short run: less than six months has passed; long run: more than six months has passed',
              'Short run: aggregate supply slopes downwards; long run: aggregate supply slopes upwards',
              'Short run: unemployment will increase in response to inflation; long run: unemployment is not affected by inflation',
            ],
            correctAnswer: 0,
            explanation: 'In the short run, wages are sticky (fixed), meaning they do not adjust immediately to changes. In the long run, all prices and wages are flexible and adjust fully.',
          },
          {
            id: 'quiz-3-4-2',
            question: 'Which of the following best describes why long-run aggregate supply is vertical at full employment output, as opposed to some other output?',
            options: [
              'Full employment output is the output associated with the natural rate of unemployment',
              'Full employment output means a country has an unemployment rate lower than the natural rate',
              'Output will always return to the level at which unemployment is zero percent',
              'Full employment output means a country has an unemployment rate higher than the natural rate',
              'Output more than full employment output is impossible',
            ],
            correctAnswer: 0,
            explanation: 'Long-run aggregate supply (LRAS) is vertical at full employment output because this output corresponds to the natural rate of unemployment, which includes frictional and structural unemployment but not cyclical unemployment.',
          },
          {
            id: 'quiz-3-4-3',
            question: 'The LRAS curve for Verminville is shown here. Which points correspond to a point on Verminville\'s production possibilities curve (PPC)?',
            options: [
              'Points S and U only',
              'Point T only',
              'Points S, T, and U',
            ...
            correctAnswer: 1,
            explanation: 'The LRAS curve represents the economy\'s potential output, which corresponds to points on the production possibilities curve (PPC). Point T lies directly on the LRAS curve, representing efficient production at full resource utilization. Point S (to the left of LRAS) represents output below potential (inside the PPC), and Point U (to the right of LRAS) represents unsustainable output (outside the PPC).',
          },
          {
            id: 'quiz-3-4-4',
            question: 'Which of the following best describes how wages respond to changes in the price level in the long run?',
            options: [
              'Wages do not adjust to changes in the price level',
              'Wages fall when the price level falls and rise when the price level rises',
              'Wages fall when the price level rises and rise when the price level falls',
              'Wages do not change when the price level increases and wages fall when the price level decreases',
              'Wages do not change when the price level falls and rise when the price level rises',
            ],
            correctAnswer: 1,
            explanation: 'In the long run, wages are flexible and adjust proportionally to changes in the price level. When the price level falls, wages also fall, and when the price level rises, wages rise, maintaining real purchasing power.',
          },
        ],
      } as QuizContent,
    ],
...
Short-run equilibrium is where AD intersects SRAS. Long-run equilibrium is where all three curves intersect. The economy can be in recessionary gap (below potential), inflationary gap (above potential), or at full employment. The model shows how price level and output are determined.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-3-5-1',
            question: 'What is the price level and real GDP associated with current output in the economy shown in this graph?',
            options: [
              'PL = 105, rGDP = $200b',
              'PL = 107, rGDP = $200b',
              'PL = 107, rGDP = $190b',
            ...
            correctAnswer: 0,
            explanation: 'Current output in the economy is determined by the intersection of the aggregate demand (AD) curve and the short-run aggregate supply (SRAS) curve. On the graph, this intersection occurs at a price level of 105 and real GDP of $200b.',
          },
          {
            id: 'quiz-3-5-2',
            question: 'If current real gross domestic product (GDP) in this country is $170 million, what is the size of the output gap?',
            options: [
              '-$20 million',
              '-$60 million',
              '$10 million',
            ...
            correctAnswer: 0,
            explanation: 'Output gap = Actual GDP - Potential GDP. If actual GDP is $170 million and potential GDP (on the production possibilities curve) is $190 million, then output gap = $170 - $190 = -$20 million (recessionary gap).',
          },
          {
            id: 'quiz-3-5-3',
            question: 'Which of the following statements is true regarding the points on the production possibilities curve (PPC) shown above?',
            options: [
              'Point T is efficient, and point U is inefficient',
              'Point T is inefficient, and point U is efficient',
              'Both points T and U are efficient',
              'Both points T and U are inefficient',
              'Point T is unattainable, and point U is efficient',
            ],
            correctAnswer: 0,
            explanation: 'Points on the production possibilities curve (PPC), such as point T, represent efficient production at full resource utilization. Points inside the PPC, such as point U, represent inefficient production or underutilization of resources.',
          },
          {
            id: 'quiz-3-5-4',
            question: 'The graph shown here illustrates the current status of the economy in Verminville. Based on this graph, which of the following is true about Verminville?',
            options: [
              'The economy is in short-run equilibrium, but not in long-run equilibrium',
              'The actual unemployment rate equals the natural rate of unemployment',
              'The country has cyclical unemployment but no structural unemployment',
              'The current unemployment rate is lower than the natural rate of unemployment',
              'The economy is at a peak in its business cycle',
            ],
            correctAnswer: 1,
            explanation: 'When all three curves (AD, SRAS, and LRAS) intersect at a single point, the economy is in long-run equilibrium. In this case, actual GDP equals potential GDP, and the actual unemployment rate equals the natural rate of unemployment.',
          },
          {
            id: 'quiz-3-5-5',
            question: 'Which point or points in the graph shown here represent a short-run equilibrium level of output?',
            options: ['D', 'E', 'B', 'C', 'A'],
            correctAnswer: 1,
            explanation: 'Short-run equilibrium occurs at the intersection of the aggregate demand (AD) curve and the short-run aggregate supply (SRAS) curve, which is labeled as point D. The level of output at this short-run equilibrium is represented by point E on the real GDP axis, which is located directly below point D.',
          },
        ],
      } as QuizContent,
    ],
...
AD shifts change both price and output in the same direction. SRAS shifts change price and output in opposite directions. Demand-pull inflation occurs when AD increases; cost-push inflation occurs when SRAS decreases. The model shows how growth, unemployment, and inflation are determined by AD and AS interactions.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-3-6-1',
            question: 'All else equal, what happens to the price level and unemployment when investment spending by firms increases?',
            options: [
              'Price level decreases; unemployment decreases',
              'Price level increases, unemployment increases',
              'Price level increases, unemployment decreases',
              'No change in the price level; unemployment decreases',
              'Price level increases, no change in unemployment',
            ],
            correctAnswer: 2,
            explanation: 'An increase in investment spending increases aggregate demand (AD), shifting the AD curve to the right. In the short run, this causes both the price level and real GDP to increase, leading to a decrease in unemployment.',
          },
          {
            id: 'quiz-3-6-2',
            question: 'Which of the following unambiguously leads to inflation?',
            options: [
              'An increase in government regulations on production and a decrease in business optimism that decreases the demand for capital',
              'An increase in expectations of inflation and a decrease in investment spending',
              'An increase in wages and an increase in consumer spending',
              'Lower expectations of inflation and fewer exports',
              'A decrease in the rental price of capital and an increase in government spending',
            ],
            correctAnswer: 2,
            explanation: 'An increase in wages shifts SRAS to the left (increases costs), and an increase in consumer spending shifts AD to the right. Both of these factors unambiguously lead to an increase in the price level (inflation).',
          },
          {
            id: 'quiz-3-6-3',
            question: 'Which of the following could cause an unanticipated increase in both the inflation rate and the unemployment rate?',
            options: [
            ...
            correctAnswer: 3,
            explanation: 'An unanticipated increase in energy prices is a negative supply shock that shifts SRAS to the left. This causes both the price level to increase (inflation) and real GDP to decrease, leading to an increase in unemployment. This phenomenon is called stagflation.',
          },
          {
            id: 'quiz-3-6-4',
            question: 'Which of the following leads to stagflation?',
            options: [
              'A positive aggregate demand (AD) shock',
              'A positive long-run aggregate supply (LRAS) shock',
              'A positive short-run aggregate supply (SRAS) shock',
              'A negative short-run aggregate supply (SRAS) shock',
              'A negative aggregate demand (AD) shock',
            ],
            correctAnswer: 3,
            explanation: 'Stagflation is the combination of stagnation (high unemployment, low growth) and inflation. A negative SRAS shock (SRAS shifting left) causes both the price level to increase (inflation) and real GDP to decrease (increased unemployment), which is the definition of stagflation.',
          },
        ],
      } as QuizContent,
    ],
...
The economy self-adjusts to potential GDP in the long run. Recessionary gaps lead to falling wages and prices, shifting SRAS right. Inflationary gaps lead to rising wages and prices, shifting SRAS left. This assumes flexible wages and prices. Adjustment may be slow, justifying policy intervention.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-3-7-1',
            question: 'The current state of the economy of Fredland is illustrated in this graph. Which of the following best describes how the economy will adjust in the long run?',
            options: [
              'Aggregate demand will increase and the price level will increase',
              'Long-run aggregate supply will increase and the price level will stay the same',
              'Short-run aggregate supply will decrease and the price level will increase',
              'Aggregate demand will decrease and the price level will increase',
              'Long-run aggregate supply will decrease and the price level will not change',
            ],
            correctAnswer: 2,
            explanation: 'When the economy has an inflationary gap (Y1 > Yf), low unemployment puts upward pressure on wages. Higher wages increase production costs, causing SRAS to shift left (decrease). This leads to an increase in the price level and a decrease in output back to the full employment level.',
          },
          {
            id: 'quiz-3-7-2',
            question: 'Which of the following best describes what will happen to this economy in the long run?',
            options: [
              ...
              'Wages and prices will decrease and output will decrease from Y1 to Yf',
              'Wages and prices will increase and output will decrease from Y1 to Yf',
              'Wages and prices will increase and output will remain at Y1',
            ],
            correctAnswer: 3,
            explanation: 'When the economy is operating above potential (Y1 > Yf), there is an inflationary gap. In the long run, low unemployment causes wages and prices to rise, shifting SRAS to the left. This causes the price level to increase and output to decrease from Y1 back to Yf (full employment output).',
          },
          {
            id: 'quiz-3-7-3',
            question: 'The economy of Hamsterville is in long-run equilibrium. The central bank of Hamsterville decided to engage in expansionary monetary policy and to buy bonds. This action increased aggregate demand (AD). What is the long-run effect of an increase in AD on the price level and the level of output?',
            options: [
              'Price level increases; output increases',
              'Price level decreases; output doesn\'t change',
              'Price level increases; output doesn\'t change',
              'Price level decreases; output increases',
            ],
            correctAnswer: 2,
            explanation: 'In the long run, an increase in aggregate demand (AD) will lead to an increase in the price level, but the level of output will return to its natural rate (potential output). In the long run, output does not change because the economy always returns to potential GDP through self-adjustment.',
          },
          {
            id: 'quiz-3-7-4',
            question: 'How are an increased potential output and an unchanged current output represented in the aggregate demand-aggregate supply (AD-AS) model?',
            options: [
              'The aggregate demand (AD) curve shifts to the right',
              'The long-run aggregate supply (LRAS) curve shifts to the right',
              'The money supply shifts to the right',
              'The demand for money shifts to the right',
              'The short-run aggregate supply (SRAS) curve shifts to the right',
            ],
            correctAnswer: 1,
            explanation: 'An increased potential output means the economy can produce more at full employment. This is represented by the LRAS curve shifting to the right, showing an increase in potential GDP. Current output remains unchanged because the LRAS shift does not directly affect the current AD-SRAS equilibrium.',
          },
        ],
      } as QuizContent,
    ],
...
Fiscal policy uses government spending and taxes to influence AD. Expansionary policy increases AD to close recessionary gaps; contractionary policy decreases AD to close inflationary gaps. The required policy change depends on the output gap and the multiplier. Both spending and tax changes can be effective, with different trade-offs.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-3-8-1',
            question: 'Before experiencing the supply shock shown in this graph, Maxistan was in long-run equilibrium. The marginal propensity to consume (MPC) Maxistan is 0.75. Which of the following is a fiscal policy action that would be the best choice to return the economy to full employment output?',
            options: [
              'Increase taxes by $75 million',
              'Decrease taxes by $25 million',
              'Increase government spending $25 million',
              'Decrease government spending $25 million',
              'Decrease government spending by $75 million',
            ],
            correctAnswer: 1,
            explanation: 'The economy has a recessionary gap of $75 million (200 - 125). Spending multiplier = 1 / (1 - 0.75) = 4. Tax multiplier = -0.75 / (1 - 0.75) = -3. To close the gap, we need to increase GDP by $75 million. Decreasing taxes by $25 million: -3 × (-$25) = +$75 million GDP. This is the correct answer.',
          },
          {
            id: 'quiz-3-8-2',
            question: 'Which of the following is a tool of discretionary fiscal policy?',
            options: [
              'International trade',
              'Government spending on a new infrastructure project',
              'Automatic stabilizers such as income taxes',
              'Buying bonds',
              'Lowering interest rates',
            ],
            correctAnswer: 1,
            explanation: 'Discretionary fiscal policy is deliberate changes in government spending or taxes by the government. Government spending on a new infrastructure project is an example of discretionary fiscal policy. Automatic stabilizers work automatically, and buying bonds and lowering interest rates are tools of monetary policy.',
          },
          {
            id: 'quiz-3-8-3',
            question: 'Which of the following would be a government spending and tax multiplier for a country?',
            options: [
              'Government spending multiplier equal 9 and tax multiplier equals -8',
              'Government spending multiplier equal 10 and tax multiplier equals -5',
              'Government spending multiplier equal 12 and tax multiplier equals -15',
              'Government spending multiplier equal 3 and tax multiplier equals -4',
              'Government spending multiplier equal -9 and tax multiplier equals -9',
            ],
            correctAnswer: 0,
            explanation: 'The tax multiplier (k_t) and spending multiplier (k_g) are related by the formula: k_t = 1 - k_g. If k_g = 9, then k_t = 1 - 9 = -8. This is the only option that satisfies this relationship. A government spending multiplier cannot be negative.',
          },
          {
            id: 'quiz-3-8-4',
            question: 'The nation of Xela was in long-run equilibrium but experienced the aggregate demand shock shown below. The marginal propensity to consume (MPC) inXela is 0.9. Which of the following is a fiscal policy action that would be the best choice to return the economy to full employment output?',
            options: [
              'Increase government spending by $2 million',
              'Decrease taxes by $20 million',
              'Increase government spending $20 million',
              'Decrease spending by $2 million',
              'Decrease government spending $20 million',
            ],
            correctAnswer: 3,
            explanation: 'The economy has an inflationary gap of $20 million (120 - 100). Spending multiplier = 1 / (1 - 0.9) = 10. To close the gap, we need to decrease GDP by $20 million. Decreasing government spending by $2 million: 10 × (-$2) = -$20 million GDP. This returns the economy to full employment output.',
          },
        ],
      } as QuizContent,
    ],
...
Automatic stabilizers are government programs that automatically stabilize the economy without explicit action. They increase spending/decrease taxes during recessions and decrease spending/increase taxes during expansions. Examples include unemployment insurance, progressive taxes, and welfare programs. They provide timely, automatic counter-cyclical effects but may not be sufficient for large economic problems.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-3-9-1',
            question: 'Tax revenues are an example of an automatic stabilizer. Which of the following best describes changes in unemployment and real GDP that cause tax revenue to increase?',
            options: [
              'Real GDP is equal to the full employment output; unemployment is less than the natural rate',
              'Real GDP is higher than full employment output; unemployment is higher than the natural rate of unemployment',
              'Real GDP is higher than full employment output; unemployment is equal to the natural rate',
              'Real GDP is lower than full employment output; unemployment is lower than the natural rate',
              'Real GDP is higher than full employment output; unemployment is lower than the natural rate',
            ],
            correctAnswer: 4,
            explanation: 'Automatic stabilizers work counter-cyclically. During expansion, when real GDP is higher than full employment output and unemployment is lower than the natural rate, incomes rise, which automatically increases tax revenues. This helps control inflation by reducing disposable income.',
          },
          {
            id: 'quiz-3-9-2',
            question: 'Hamsterville has a progressive income tax and a social insurance program that provides unemployed workers with a basic income while they are searching for jobs. What impact will this progressive tax system have on real GDP?',
            options: [
              'We cannot tell the impact taxes will have on real GDP',
              'Increase real GDP during every phase of the business cycle',
              'Decrease real GDP during the expansion phase; increase real GDP during the recession phase',
              'Increase real GDP during the expansion phase; decrease real GDP during the recession phase',
              'Decrease real GDP during all phases of the business cycle',
            ],
            correctAnswer: 2,
            explanation: 'A progressive tax system acts as an automatic stabilizer. During expansion, higher incomes lead to higher taxes (decreasing real GDP), and during recession, lower incomes lead to lower taxes (increasing real GDP). The social insurance program also works counter-cyclically, increasing transfers during recession.',
          },
          {
            id: 'quiz-3-9-3',
            question: 'Which of the following best describes the function of automatic stabilizers in an economy?',
            options: [
              'They increase unemployment during recessions',
              'They eliminate the business cycle',
              'They ensure that budgets are balanced',
              'They decrease tax revenues when gross domestic product decreases',
              'They move the economy further away from full-employment output',
            ],
            correctAnswer: 3,
            explanation: 'Automatic stabilizers work counter-cyclically. When GDP decreases (recession), they automatically decrease tax revenues (due to lower incomes) and increase transfers (e.g., unemployment benefits), which helps stabilize the economy without the need for conscious government action.',
          },
          {
            id: 'quiz-3-9-4',
            question: 'Which of the following is an example of an automatic stabilizer that helps control inflation?',
            options: [
              'An increase in income tax revenue collected',
              'An increase in the reserve ratio',
              'An increase in spending on unemployment payments',
              'An increase in discretionary government spending',
              'An increase in the money supply',
            ],
            correctAnswer: 0,
            explanation: 'Automatic stabilizers help control inflation by automatically increasing tax revenues during economic expansion. When the economy grows and incomes rise, the progressive tax system automatically collects more taxes, reducing disposable income and helping control inflation without conscious government action.',
          },
        ],
      } as QuizContent,
    ],
...
Interest is the price of borrowing money. Bonds are debt instruments with fixed payments. Bond prices and interest rates move inversely. Stocks represent ownership in companies with variable returns. Bonds are lower risk with fixed returns; stocks are higher risk with potential for higher returns.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-4-1-1',
            question: 'If the interest rate on bonds increases, which of the following is the most likely result?',
            options: [
              'The quantity demanded of money increases',
              'The supply of money decreases',
              'Bond prices increase',
              'The transaction costs associated with holding money will increase',
              'People will be willing to hold less wealth in the form of money',
            ],
            correctAnswer: 4,
            explanation: 'When the interest rate on bonds increases, the opportunity cost of holding money (the cost of forgone opportunities) also increases. People will want to hold less money and more bonds to earn higher interest. This decreases the demand for money.',
          },
          {
            id: 'quiz-4-1-2',
            question: 'Daenerys bought government bonds with a face value of $1000 last year. At the time, she could have earned 6% interest if she had deposited money in a savings account at the Iron Bank. All of a sudden, interest rates at the Iron Bank increased to 9%. What will happen to the price of Daenerys\'s bonds?',
            options: [
              'The price of the bonds will increase',
              'The price of the bonds will decrease',
              'The price of bonds is unaffected by the interest rate',
              'The price of the bond will become the price that makes the interest earned on both assets equal',
              'The price of the bond will remain $1000',
            ],
            correctAnswer: 1,
            explanation: 'When interest rates rise, new bonds offer higher interest. Existing bonds with lower rates become less attractive, so their prices fall to equalize their effective yield with new bonds. Bond prices and interest rates are inversely related.',
          },
          {
            id: 'quiz-4-1-3',
            question: 'All else equal, which of the following financial assets carries the most risk?',
            options: ['Stocks', 'Savings deposits', 'Bonds', 'Checking deposits', 'Cash'],
            correctAnswer: 0,
            explanation: 'Stocks carry the most risk because their value can fluctuate significantly, and investors can lose their entire investment. Savings deposits, bonds, checking deposits, and cash are safer, with less risk of loss of value.',
          },
          {
            id: 'quiz-4-1-4',
            question: 'Which of the following financial assets is the most liquid?',
            options: ['Gold', 'Bonds', 'Savings accounts', 'Money', 'Stocks'],
            correctAnswer: 3,
            explanation: 'Money (cash and checking deposits) is the most liquid asset because it can be immediately used for transactions without loss of value. Gold, bonds, savings accounts, and stocks require conversion to money before use in transactions, so they are less liquid.',
          },
        ],
      } as QuizContent,
    ],
...
Nominal return is the stated return; real return adjusts for inflation. Real return = Nominal return - Inflation. The Fisher equation relates nominal, real, and inflation rates. Real returns matter for purchasing power. Indexing adjusts payments for inflation but has limitations.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-4-2-1',
            question: 'Hodor borrowed $1000. The bank charges him 5% interest per year. At the end of one year, he paid $50 in interest. During that year, there was a 2% increase in the GDP deflator. What was the nominal interest rate?',
            options: ['3%', '2%', '5%', 'This cannot be determined without more information', '7%'],
            correctAnswer: 2,
            explanation: 'The nominal interest rate is the rate that the bank actually charges, without adjustment for inflation. In this case, the bank charges 5% per year, so the nominal interest rate is 5%. The inflation information (2%) is needed to calculate the real interest rate, but not to determine the nominal rate.',
          },
          {
            id: 'quiz-4-2-2',
            question: 'Ygritte loaned Mans $100. Mans paid her back $110 one year later. The annual rate of inflation was 3%. What was the real interest rate that Ygritte earned on this loan?',
            options: ['$100', '3%', '$10', '7%', '10%'],
            correctAnswer: 3,
            explanation: 'Nominal interest rate = ($110 - $100) / $100 = 10%. Real interest rate = Nominal rate - Inflation = 10% - 3% = 7%. The real interest rate shows the actual purchasing power of the interest earned.',
          },
          {
            id: 'quiz-4-2-3',
            question: 'The Iron Bank wants to make sure that the purchasing power of the interest that they get paid on loans is at least 11%. Real GDP is increasing at 5% per year, and the expected rate of inflation is 7% per year. If all banks in Westeros want to earn the same real return as the Iron Bank, what is the nominal interest rate (n.i.r) in Westeros?',
            options: ['11%', '-1%', '13%', '18%', '7%'],
            correctAnswer: 3,
            explanation: 'Nominal interest rate = Real interest rate + Expected inflation. If banks want a real return of 11%, and expected inflation is 7%, then nominal interest rate = 11% + 7% = 18%.',
          },
          {
            id: 'quiz-4-2-4',
            question: 'Which of the following best describes the difference between nominal interest rates and real interest rates?',
            options: [
              ...
              'nominal interest is adjusted for inflation; real interest is what borrowers pay',
            ],
            correctAnswer: 0,
            explanation: 'The nominal interest rate is the rate without adjustment for inflation - it\'s the actual rate you see. The real interest rate is the nominal rate adjusted for inflation, showing the actual purchasing power. Real rate = Nominal rate - Inflation.',
          },
        ],
      } as QuizContent,
    ],
...
Money supply is measured as M0, M1, and M2. Money serves as medium of exchange, unit of account, store of value, and standard of deferred payment. Commodity money has intrinsic value; fiat money is accepted by government decree. Hyperinflation destroys money's functions, causing economic collapse.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-4-3-1',
            question: 'Which of the following is a function of money that is most immediately impacted by hyperinflation?',
            options: [
              'Store of value',
              'Menu costs',
              'Unit of account',
            ...
            correctAnswer: 0,
            explanation: 'The store of value function of money is most immediately impacted by hyperinflation. When hyperinflation occurs, prices rise extremely rapidly, causing money to lose its value very quickly. People can no longer rely on money to maintain its purchasing power over time, which directly undermines money\'s function as a store of value. While hyperinflation also affects the unit of account and medium of exchange functions, the store of value function is the most immediately and severely impacted because money\'s ability to preserve value over time is destroyed when prices are rising so rapidly.',
          },
          {
            id: 'quiz-4-3-2',
            question: 'Which of the following best explains why a $20 bill is money but a share of stock is not money?',
            options: [
              'The $20 bill can be used as a medium of exchange, but the share of stock cannot be used to purchase anything.',
              'The $20 bill does not earn income, but the share of stock does earn income.',
              'The $20 bill is an illiquid asset, but the share of stock is a liquid asset.',
              'The $20 bill is a store of value, but the share of stock is risky.',
              'The $20 bill is not an asset, but a share of stock is an asset.',
            ],
            correctAnswer: 0,
            explanation: 'A $20 bill is money because it can be used as a medium of exchange - it is widely accepted as payment for goods and services. A share of stock is not money because, while it is a financial asset, it cannot be directly used to purchase goods and services. To use a share of stock to buy something, you would first need to sell it for money. The key characteristic that makes something money is its function as a medium of exchange, which requires widespread acceptance as payment.',
          },
          {
            id: 'quiz-4-3-3',
            question: 'Felipe deposits $100 in the bank. The bank stores $20 of his deposit in a vault and will loan out other $80. The $20 stored in the bank vault is part of which of the following?',
            options: [
              'M1',
              'M3',
              'The monetary base',
            ...
            correctAnswer: 2,
            explanation: 'The $20 stored in the bank vault is part of the monetary base. The monetary base (also called high-powered money) consists of currency in circulation plus bank reserves (currency held in bank vaults and deposits at the central bank). The $20 in the vault represents bank reserves, which are part of the monetary base. M1 and M2 are broader measures of the money supply that include currency in circulation and various types of deposits, but they do not include reserves held in bank vaults. Near money refers to assets that are easily convertible to money but are not money themselves.',
          },
          {
            id: 'quiz-4-3-4',
            question: 'Which of the following best describes the monetary aggregate M1?',
            options: [
              'Currency in circulation + gold bricks + currency in vaults',
              'Currency in circulation + Demand deposits + travelers checks + savings accounts',
              'Currency in circulation + Demand deposits + travelers checks + small time deposits',
              'Currency in circulation + Demand deposits + travelers checks + Currency in vaults',
              'Currency in circulation + Demand deposits + travelers checks',
            ],
            correctAnswer: 4,
            explanation: 'M1 is best described as currency in circulation plus demand deposits plus travelers checks. M1 is the narrowest measure of the money supply and includes only the most liquid forms of money: currency held by the public (not in bank vaults), checking account deposits (demand deposits), and travelers checks. It does not include currency in bank vaults (which are reserves), savings accounts, time deposits, or gold. M2 includes M1 plus savings accounts and small time deposits, making it a broader measure.',
          },
        ],
      } as QuizContent,
    ],
...
Fractional reserve banking allows banks to hold only a fraction of deposits as reserves. Banks create money through lending. The money multiplier shows how deposits expand the money supply. Fractional reserve banking has risks (bank runs, liquidity) but enables credit creation. Full reserve banking eliminates these risks but prevents money creation.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-4-4-1',
            question: 'Required reserves are best described by which of the following statements?',
            options: [
              'the amount a bank has to pay for an overnight loan from another bank',
              'the money owed to a bank\'s owners',
              'the money that a bank can loan out',
              'the proportion of checkable deposits that a bank must keep on hand',
              'the proportion of the total assets the bank holds as bonds',
            ],
            correctAnswer: 3,
            explanation: 'Required reserves are the minimum proportion of checkable deposits that a bank must keep in reserve (in its vault or at the central bank) as required by the central bank. They cannot be loaned out.',
          },
          {
            id: 'quiz-4-4-2',
            question: 'When Hodor deposited $1000 in the bank, the bank kept $200 in its vault and loaned out $800. Which of the following best describes what the bank is doing?',
            options: [
              'Investment banking',
              'Full reserve banking',
              'Excess reserve banking',
              'Required reserve banking',
              'Fractional reserve banking',
            ],
            correctAnswer: 4,
            explanation: 'Fractional reserve banking is a system where banks keep only a fraction of deposits as reserves (in this case 20%) and loan out the rest (80%). This allows banks to create money through lending.',
          },
          {
            id: 'quiz-4-4-3',
            question: 'Banks in Westeros have been required to keep 10% of all checkable deposits on reserve, but now the central bank has changed the reserve requirement to 20%. What immediate effect does this have on banks\' balance sheets?',
            options: [
            ...
            correctAnswer: 4,
            explanation: 'When the reserve requirement increases from 10% to 20%, banks must keep a larger proportion of deposits as reserves. This means that some of their excess reserves (reserves above the requirement) now become required reserves, so excess reserves decrease.',
          },
          {
            id: 'quiz-4-4-4',
            question: 'Milton deposits $100,000 in the First Bank of the Shire. Which of the following best describes the initial impact this deposit will have on the bank\'s balance sheet?',
            options: [
              'Assets will increase; liabilities will not change',
              'Assets will not change; liabilities will increase',
            ...
            correctAnswer: 2,
            explanation: 'When a customer deposits money in a bank, the bank receives cash (an asset) and simultaneously has a liability to the depositor (a liability). The deposit increases both the bank\'s assets (cash in vault) and liabilities (customer deposits).',
          },
        ],
      } as QuizContent,
    ],
...
The demand for money is downward sloping (higher interest rates reduce money demand). Money market equilibrium occurs where supply equals demand, determining the interest rate. Changes in money supply or demand shift the equilibrium interest rate. The money market connects monetary policy to interest rates.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-4-5-1',
            question: 'Which of the following leads to a decrease in the demand for money?',
            options: [
              'The demand for bonds decreases',
              'Output increases',
              'Nominal gross domestic product (GDP) increases',
              'A lower price level',
              'People want to hold more money.',
            ],
            correctAnswer: 3,
            explanation: 'A lower price level leads to a decrease in the demand for money because people need less money to make the same transactions. When prices are lower, the same amount of goods and services can be purchased with less money, reducing the transactions demand for money.',
          },
          {
            id: 'quiz-4-5-2',
            question: 'Assume that people keep all money in banks. What happens if banks decide to start keeping excess reserves instead of fully loaning out?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'If banks keep excess reserves instead of loaning out money, the money supply decreases. This is because the money multiplier effect is reduced - when banks hold excess reserves, they are not creating new money through the lending process. Less lending means less money creation, resulting in a smaller money supply.',
          },
          {
            id: 'quiz-4-5-3',
            question: 'What happens to the nominal interest rate and the quantity of money in the money supply if the demand for money increases?',
            options: [
              'Nominal interest rate increases; the quantity of money decreases.',
              'Nominal interest rate decreases; the quantity of money increases.',
              'Nominal interest rate increases; no change in the quantity of money.',
              'Nominal interest rate decreases; no change in the quantity of money.',
              'Nominal interest rate increases; the quantity of money increases.',
            ],
            correctAnswer: 2,
            explanation: 'When the demand for money increases and the money supply remains unchanged, the nominal interest rate increases with no change in the quantity of money. This occurs because the increased demand for money creates upward pressure on interest rates (people are willing to pay more to hold money), but the central bank has not changed the money supply, so the quantity of money stays the same.',
          },
        ],
      } as QuizContent,
    ],
...
Monetary policy uses money supply and interest rates to influence the economy. Tools include open market operations, reserve requirements, discount rate, and interest on reserves. Expansionary policy increases money supply to fight recessions; contractionary policy decreases money supply to fight inflation. Monetary and fiscal policy can work together or independently.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-4-6-1',
            question: 'Which of the following is a monetary policy tool that would be used by a central bank to close a recessionary gap?',
            options: [
            ...
            correctAnswer: 4,
            explanation: 'Buying bonds is an expansionary monetary policy tool (open market operations) that the central bank uses to close a recessionary gap. When the central bank buys bonds, it injects money into the economy, increases the money supply, lowers interest rates, and stimulates economic activity. The other options are either contractionary (increase discount rate, increase reserve ratio) or fiscal policy tools (decrease taxes, increase government spending), not monetary policy tools.',
          },
          {
            id: 'quiz-4-6-2',
            question: 'Which of the following interest rates is a central bank MOST LIKELY to target directly when using monetary policy?',
            options: [
              'The overnight interbank lending rate',
              'The long-term interest rate',
              'The real interest rate',
              'The central bank-to-bank lending rate',
              'The home lending interest rate',
            ],
            correctAnswer: 0,
            explanation: 'The overnight interbank lending rate (also known as the federal funds rate in the U.S.) is the rate that central banks most directly target when conducting monetary policy. Central banks use open market operations to influence this short-term rate, which then affects other interest rates throughout the economy. While central banks influence long-term rates indirectly, they directly control the overnight interbank rate through their monetary policy tools.',
          },
          {
            id: 'quiz-4-6-3',
            question: 'Which of the following is the rate that banks in the United States charge each other for overnight loans?',
            options: [
              'LIBOR',
              'The discount rate',
              'The prime rate',
            ...
            correctAnswer: 4,
            explanation: 'The federal funds rate is the interest rate that banks in the United States charge each other for overnight loans of reserves. This is the rate that the Federal Reserve targets through monetary policy. LIBOR is an international benchmark rate, the discount rate is what the Fed charges banks, the prime rate is what banks charge their best customers, and the reserve requirement is the percentage of deposits banks must hold, not an interest rate.',
          },
          {
            id: 'quiz-4-6-4',
            question: 'First Bank is one of many banks in the banking system in Hamsterville. The central bank of Hamsterville sells bonds to First Bank. What is the immediate impact of the central bank\'s action?',
            options: [
              'Aggregate demand increases.',
              'Interest rates decrease.',
              'First Bank\'s excess reserves decrease',
              'The demand for money decreases.',
              'The monetary supply increases',
            ],
            correctAnswer: 2,
            explanation: 'When a central bank sells bonds to a commercial bank, the immediate impact is that the commercial bank\'s excess reserves decrease. The bank pays for the bonds by drawing down its reserves held at the central bank. This is a contractionary monetary policy action that reduces the money supply and increases interest rates, but the immediate, direct effect on First Bank is the reduction of its excess reserves.',
          },
        ],
      } as QuizContent,
    ],
...
The loanable funds market shows supply (saving) and demand (investment) for funds. Equilibrium determines the interest rate and quantity of funds. National saving equals investment in equilibrium. Changes in saving or investment shift the curves, changing the interest rate.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-4-7-1',
            question: 'Which of the following leads to a lower real interest rate?',
            options: [
              'The national budget moves from a deficit to a surplus.',
              'People save less.',
              'Investment demand by firms increases.',
              'Foreign savers view the market as risky.',
              'People want to borrow more money.',
            ],
            correctAnswer: 0,
            explanation: 'When the national budget moves from a deficit to a surplus, public saving increases, which increases national saving. This increases the supply of loanable funds, shifting the supply curve to the right. With unchanged demand, the equilibrium real interest rate decreases. The other options would either decrease supply (people save less, foreign savers view market as risky) or increase demand (investment demand increases, people want to borrow more), both of which would increase the real interest rate.',
          },
          {
            id: 'quiz-4-7-2',
            question: 'The government of Burginville currently has a balanced budget. Rampant consumer spending in Burginville has led to a decrease in national savings, which has affected real interest rates in Burginville. Which action could the government of Burginville take to offset the effect of a decrease in national savings on real interest rates?',
            options: [
            ...
            correctAnswer: 3,
            explanation: 'Running a budget surplus would increase public saving, which would increase national saving. This would offset the decrease in national savings caused by rampant consumer spending. An increase in national saving increases the supply of loanable funds, which would help lower or stabilize real interest rates. The other options would either decrease national saving further (budget deficit, increase government spending) or are monetary policy tools that don\'t directly affect the loanable funds market in the same way.',
          },
          {
            id: 'quiz-4-7-3',
            question: 'People in Hamsterville are looking forward to a long, fun-filled retirement and are saving more money to make sure they can go on trips around the world when they retire. What happens to the interest rate and long-run aggregate supply (LRAS) as a result of what happens to the interest rate?',
            options: [
              'Interest rate increases; LRAS increases',
              'Interest rate decreases; LRAS is unaffected',
              'Interest rate doesn\'t change; LRAS doesn\'t change',
              'Interest rate decreases; LRAS increases',
              'Interest rate increases; LRAS decreases',
            ],
            correctAnswer: 3,
            explanation: 'When people save more, the supply of loanable funds increases, which decreases the interest rate. The lower interest rate encourages more investment spending by firms. Increased investment leads to a larger capital stock in the economy. A larger capital stock increases the economy\'s productive capacity, which increases long-run aggregate supply (LRAS). Therefore, the interest rate decreases and LRAS increases.',
          },
          {
            id: 'quiz-4-7-4',
            question: 'Citizens in Fredland are saving more. Which of the following best describes the impact of this statement on the market for loanable funds?',
            options: [
              'The demand for loanable funds decreases and the supply of loanable funds decreases and the effect on the interest rate is indeterminate.',
              'The demand for loanable funds decreases and the real interest rate decreases.',
              'The demand for loanable funds increases and the real interest rate increases.',
              'The supply of loanable funds increases and the real interest rate decreases.',
              'The supply of loanable funds decreases and the real interest rate increases.',
            ],
            correctAnswer: 3,
            explanation: 'When citizens save more, the supply of loanable funds increases (saving represents the supply side of the loanable funds market). With an increased supply of loanable funds and unchanged demand, the equilibrium real interest rate decreases. This is a fundamental relationship in the loanable funds market: more saving increases supply, which lowers the interest rate.',
          },
          {
            id: 'quiz-4-7-5',
            question: 'What relationship is illustrated using the demand for loanable funds?',
            options: [
              'Individuals respond to lower interest rates by increasing the amount of money they hold.',
              'The central bank responds to higher interest rates by supplying more money.',
              'Investors respond to an increase in interest rates by investing more money.',
            ...
            correctAnswer: 3,
            explanation: 'The demand for loanable funds curve illustrates the relationship between the interest rate and the quantity of loanable funds demanded by borrowers. It is downward sloping, showing that borrowers respond to lower real interest rates by borrowing more money (and vice versa). This represents the investment demand by firms and borrowing by households and government. The other options describe relationships for money demand, monetary policy, or the supply of loanable funds, not the demand for loanable funds.',
          },
        ],
      } as QuizContent,
    ],
...
Fiscal and monetary policy can work together or conflict. Coordinated policies are more effective. Both affect aggregate demand in the short run. Fiscal policy has direct effects; monetary policy works through interest rates. Policy coordination requires communication between government and central bank.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-5-1-1',
            question: 'King Thranduil of the Woodland Realm is trying to rescue the kingdom from a severe recession by engaging in expansionary fiscal policy. As a result of the expansionary fiscal policy, the Woodland Realm now has a budget deficit. Meanwhile, the president of the central bank is Smaug, who wants to maintain a steady interest rate. What is the appropriate action for the central bank to take in order to reduce the impact of the expansionary fiscal policy on interest rates?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'When expansionary fiscal policy (increased government spending or decreased taxes) creates a budget deficit, it increases the demand for loanable funds, which puts upward pressure on interest rates. To maintain a steady interest rate, the central bank should engage in expansionary monetary policy by buying bonds. This increases the money supply, which helps offset the upward pressure on interest rates caused by the fiscal policy, allowing the central bank to maintain steady interest rates.',
          },
          {
            id: 'quiz-5-1-2',
            question: 'The economy of Mithrim is in a severe recession. The government is implementing expansionary fiscal policy, and the central bank is considering expansionary monetary policy to aid recovery. Which of the following is an example of a monetary policy action that would work with the expansionary fiscal policy to close the output gap?',
            options: [
              'Increase taxes',
            ...
            correctAnswer: 4,
            explanation: 'Open market purchases (buying bonds) is an expansionary monetary policy action that works with expansionary fiscal policy to close a recessionary output gap. When the central bank buys bonds, it increases the money supply, lowers interest rates, and stimulates aggregate demand through increased investment and net exports. This complements expansionary fiscal policy (which directly increases government spending or reduces taxes) to provide strong stimulus to close the output gap. The other options are either contractionary monetary policy (selling bonds, increasing discount rate) or fiscal policy tools (increase taxes, increase government spending), not expansionary monetary policy.',
          },
          {
            id: 'quiz-5-1-3',
            question: 'The Council of Elrond has decided to increase taxes, and the central bank of Elrond has decided to conduct open market sales of financial assets. Assuming that wages are sticky, which of the following best describes the impact of these actions on real output and the price level?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'Increasing taxes is contractionary fiscal policy (reduces disposable income and consumption), and open market sales are contractionary monetary policy (reduces money supply and increases interest rates). Both policies reduce aggregate demand. When both fiscal and monetary policy are contractionary, aggregate demand decreases unambiguously. With sticky wages (short-run), this leads to both a decrease in real output and a decrease in the price level. The combined contractionary effects are clear: lower output and lower prices.',
          },
        ],
      } as QuizContent,
    ],
...
The short-run Phillips Curve shows a trade-off between inflation and unemployment. The long-run Phillips Curve is vertical at the natural unemployment rate. Changes in AD-AS correspond to movements along the SRPC. Supply shocks shift the SRPC. In the long run, there is no trade-off between inflation and unemployment.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-5-2-1',
            question: 'Which of the following best describes the relationship that the short-run Phillips curve (SRPC) illustrates?',
            options: [
              'The full employment output is independent of changes in the price level',
              'the natural rate of unemployment is independent of changes in the inflation rate',
              'the tradeoff between liquidity and earning interest',
              'the tradeoff between unemployment and inflation',
              'The maximum sustainable amount of production in an economy',
            ],
            correctAnswer: 3,
            explanation: 'The short-run Phillips curve (SRPC) illustrates the tradeoff between unemployment and inflation. It is downward sloping, showing that in the short run, lower unemployment is associated with higher inflation, and higher unemployment is associated with lower inflation. This tradeoff exists because when aggregate demand increases, both output (which reduces unemployment) and prices (which increases inflation) tend to rise in the short run.',
          },
          {
            id: 'quiz-5-2-2',
            question: 'Which of the following best describes the long-run Phillips curve ("LRPC")?',
            options: [
              'vertical at the natural rate of unemployment',
              'Vertical at the current rate of unemployment',
              'Upward sloping showing the positive relationship between inflation and unemployment',
              'downward sloping showing the tradeoff between inflation and unemployment',
              'Upward sloping showing the positive relationship between output and the price level',
            ],
            correctAnswer: 0,
            explanation: 'The long-run Phillips curve (LRPC) is vertical at the natural rate of unemployment. This means that in the long run, there is no tradeoff between inflation and unemployment. Regardless of the inflation rate, unemployment will return to its natural rate (the sum of frictional and structural unemployment). The vertical LRPC reflects the fact that in the long run, wages and prices adjust fully, and the economy returns to its natural level of unemployment.',
          },
          {
            id: 'quiz-5-2-3',
            question: 'The natural rate of unemployment in Elizaland is 5%. The citizens of Elizaland expected inflation to be 2% and unemployment to be 5% during 2018. However, inflation turned out to be 6% and unemployment 1.5%. What happens in the long run as people begin to expect a permanently higher rate of inflation?',
            options: [
            ...
            correctAnswer: 0,
            explanation: 'When people begin to expect a permanently higher rate of inflation, the short-run Phillips curve (SRPC) shifts to the right (upward). This is because higher expected inflation becomes incorporated into wage and price setting. The SRPC shifts because at any given unemployment rate, inflation will be higher when expected inflation is higher. The long-run Phillips curve (LRPC) does not shift because it is determined by the natural rate of unemployment, which is independent of inflation expectations. The LRPC remains vertical at the natural rate of unemployment (5% in this case).',
          },
          {
            id: 'quiz-5-2-4',
            question: 'What causes the long-run Phillips curve to shift?',
            options: [
            ...
            correctAnswer: 0,
            explanation: 'The long-run Phillips curve (LRPC) shifts when there are changes in structural or frictional unemployment, which together determine the natural rate of unemployment. The LRPC is vertical at the natural rate of unemployment, so any change in the natural rate (due to changes in structural factors like technology, labor market institutions, or frictional factors like job search efficiency) will shift the LRPC. Changes in cyclical unemployment, inflation expectations, or shifts in AD/SRAS curves affect the short-run Phillips curve, not the long-run curve, because the LRPC represents the natural rate that the economy returns to in the long run regardless of these factors.',
          },
        ],
      } as QuizContent,
    ],
...
The quantity theory states that money supply growth causes inflation (if V and Y constant). Velocity changes can also drive prices. Deflation can occur despite money growth if velocity falls or output grows faster. Moderate inflation in a growing economy is normal and often targeted by central banks.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-5-3-1',
            question: 'Which of the following ideas is the quantity theory of money used to demonstrate?',
            options: [
              'Real output never changes',
              'Deflation occurs when the money supply increases faster than real output increases',
              ...
              'Real variables can be influenced by monetary policy in the long run',
            ],
            correctAnswer: 2,
            explanation: 'The quantity theory of money is used to demonstrate that inflation occurs because the money supply increases faster than real output increases. The equation of exchange (M × V = P × Y) shows that if velocity (V) and real output (Y) are relatively constant, an increase in the money supply (M) will lead to an increase in the price level (P), which is inflation. The theory emphasizes that excessive money supply growth relative to output growth is the primary cause of inflation.',
          },
          {
            id: 'quiz-5-3-2',
            question: 'According to the quantity theory of money, changes in which variable(s) from the equation of exchange determine(s) the rate of inflation in the long run?',
            options: [
              'Y only',
              'V only',
              'Y and V',
            ...
            correctAnswer: 4,
            explanation: 'According to the quantity theory of money, changes in M (money supply) only determine the rate of inflation in the long run. The equation of exchange is M × V = P × Y. In the long run, real output (Y) is determined by real factors (technology, resources, labor) and is not affected by monetary policy. Velocity (V) is assumed to be relatively stable or constant in the long run. Therefore, changes in the money supply (M) directly determine changes in the price level (P), which is inflation. This is the core of the quantity theory: money supply growth causes inflation.',
          },
          {
            id: 'quiz-5-3-3',
            question: 'According to the quantity theory of money, what happens if the money supply increases by 10% if the current rate of unemployment is equal to the natural rate of unemployment?',
            options: [
              'The price level increases by 10%',
              'Real output increases 10%',
              'Real output increases more than the increase in the price level',
              'Real output and the velocity of money both increase',
              'The price level increases by 5% and real output increases by 5%',
            ],
            correctAnswer: 0,
            explanation: 'If the unemployment rate equals the natural rate of unemployment, the economy is at full employment, meaning real output (Y) is at its potential level and cannot increase in the long run. According to the quantity theory, if velocity (V) is constant and real output (Y) is fixed at potential, then a 10% increase in the money supply (M) will lead to a 10% increase in the price level (P). This is because M × V = P × Y, so if M increases 10% and V and Y are unchanged, P must increase by 10%.',
          },
          {
            id: 'quiz-5-3-4',
            question: 'According to monetarists, what is the primary cause of inflation?',
            options: [
              'A rapidly changing velocity of money',
              'The money supply decreases too rapidly for a long time',
              'A stable velocity of money',
              'Any increase in the money supply',
              'The money supply increases faster than real output increases',
            ],
            correctAnswer: 4,
            explanation: 'According to monetarists, the primary cause of inflation is when the money supply increases faster than real output increases. Monetarists, following Milton Friedman\'s famous statement that "inflation is always and everywhere a monetary phenomenon," believe that excessive money supply growth relative to output growth is the root cause of inflation. While velocity can change, monetarists emphasize that sustained inflation requires money supply growth that exceeds the growth in real output. A stable velocity of money supports this relationship, but the key is the relative growth rates of money supply and output.',
          },
        ],
      } as QuizContent,
    ],
...
Crowding out occurs when government spending reduces private spending, typically through higher interest rates. It's more likely near full employment with fixed money supply. Crowding out can be complete, partial, or absent depending on economic conditions. Monetary accommodation can reduce crowding out.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-5-4-1',
            question: 'Which of the following is the most likely way a government will finance deficit spending?',
            options: [
            ...
            correctAnswer: 2,
            explanation: 'The most likely way a government will finance deficit spending is through borrowing. When the government runs a budget deficit (spending exceeds tax revenue), it must finance the shortfall. Governments typically borrow by issuing bonds to domestic and foreign investors. While printing money is technically possible, it leads to inflation and is generally avoided. Increasing public saving would require a budget surplus, not a deficit. Decreasing the discount rate and buying bonds are monetary policy actions by the central bank, not fiscal policy tools for financing deficits.',
          },
          {
            id: 'quiz-5-4-2',
            question: 'Which of the following best describes the chain of events in the relationship between deficits and potential output?',
            options: [
              'Deficits → lower real interest rates → less private investment → smaller capital stock → slower growth of potential output',
              'Deficit → higher real interest rates → more private investment → larger capital stock → faster growth of potential output',
              'Deficits → higher real interest rates → less private investment → larger capital stock → faster growth of potential output',
              'Deficits → lower real interest rates → more private investment → larger capital stock → faster growth of potential output',
              'Deficit → higher real interest rates → less private investment → smaller capital stock → slower growth of potential output',
            ],
            correctAnswer: 4,
            explanation: 'The correct chain of events is: Deficits → higher real interest rates → less private investment → smaller capital stock → slower growth of potential output. When the government runs a budget deficit, it increases the demand for loanable funds, which raises real interest rates. Higher interest rates make borrowing more expensive for private firms, reducing private investment. Less investment means a smaller capital stock over time, which reduces the economy\'s productive capacity and leads to slower growth of potential output. This is the crowding out effect.',
          },
          {
            id: 'quiz-5-4-3',
            question: 'An economy has a budget deficit, and you want to show the impact of the budget deficit on the real interest rate. What model would you use, and what would be the impact on the interest rate?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'To show the impact of a budget deficit on the real interest rate, you would use the loanable funds market, and the real interest rate increases. In the loanable funds market, a budget deficit represents negative public saving, which reduces national saving. This decreases the supply of loanable funds, shifting the supply curve to the left. With unchanged demand, the equilibrium real interest rate increases. The money market shows the relationship between money supply/demand and nominal interest rates, not real interest rates. The AD-AS model shows price level and output, not interest rates directly.',
          },
          {
            id: 'quiz-5-4-4',
            question: 'What does the term "crowding out" refer to?',
            options: [
              'When there is an increase in unemployment, spending on automatic stabilizers increases',
              'When private sector borrowing increases, government borrowing decreases',
              'When there is a decrease in tax revenue, revenue from automatic stabilizers decrease',
              'When one private industry within an economy borrows more, other sectors of the economy borrow less',
              'When government borrowing increases, private sector investment spending decreases',
            ],
            correctAnswer: 4,
            explanation: 'Crowding out refers to when government borrowing increases, private sector investment spending decreases. This occurs because when the government runs a budget deficit and borrows to finance it, it increases the demand for loanable funds, raising real interest rates. Higher interest rates make borrowing more expensive for private firms, reducing their investment spending. The government\'s increased borrowing "crowds out" private investment by competing for the same pool of loanable funds and driving up interest rates.',
          },
        ],
      } as QuizContent,
    ],
...
Budget deficits occur when spending exceeds revenue. National debt is accumulated deficits. Deficits can stimulate the economy short-term but create long-term concerns. Debt-to-GDP ratio measures debt burden. Sustainable debt requires GDP growth to outpace debt growth.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-5-5-1',
            question: 'The government of Kashyyyk has a $200 million national debt which accrues 10% interest annually. The government would like to maintain a balanced budget and reduce the size of the national debt, but also does not want to change transfer payments. Which of the following actions will achieve the government of Kashyyyk\'s goals?',
            options: [
              'Increase tax revenues by $20 million',
              'Borrow money from another government agency',
              'Borrow money from foreign entities to make interest payments',
              'Increase tax revenues by more than $20 million',
              'Issue government bonds',
            ],
            correctAnswer: 3,
            explanation: 'To maintain a balanced budget and reduce the national debt, the government must increase tax revenues by more than $20 million. The annual interest payment on the $200 million debt at 10% is $20 million. To maintain a balanced budget, the government needs at least $20 million in additional revenue to cover the interest payment. However, to reduce the national debt, the government needs a budget surplus, which requires revenue to exceed all expenses (including the $20 million interest payment). Therefore, increasing tax revenues by more than $20 million will cover the interest payment (balanced budget) and provide additional funds to pay down the principal of the debt (reducing the national debt). Borrowing (options B, C, E) would increase the debt, and increasing revenues by exactly $20 million (option A) would only balance the budget without reducing the debt.',
          },
          {
            id: 'quiz-5-5-2',
            question: 'The government of Cloud City spent $100 million more than it had in tax revenues this year. What is the impact of this shortage on the budget balance and national debt in Cloud City?',
            options: [
              ...
              'There is a budget surplus; no impact on the national debt',
              'There is a budget deficit; no impact on the national debt',
            ],
            correctAnswer: 0,
            explanation: 'When the government spends $100 million more than it collects in tax revenues, there is a budget deficit. A budget deficit occurs when government spending exceeds tax revenues. To finance this deficit, the government must borrow money, which increases the national debt. The national debt is the accumulation of all past budget deficits (minus surpluses). Therefore, a budget deficit directly leads to an increase in the national debt.',
          },
          {
            id: 'quiz-5-5-3',
            question: 'Which of the following best describes the circumstances in which a government will run a budget deficit?',
            options: [
              'When a government runs a high debt to income ratio',
              'Tax revenues are more than the sum of the government spending component of real GDP and transfer payments',
              'Tax revenues are less than the sum of the government spending component of real GDP and transfer payments',
              'The accumulation of budget shortfalls over time',
              'When a government engages in contractionary fiscal policy',
            ],
            correctAnswer: 2,
            explanation: 'A government will run a budget deficit when tax revenues are less than the sum of the government spending component of real GDP and transfer payments. A budget deficit occurs when total government expenditures (which include both government purchases of goods and services, which are part of GDP, and transfer payments) exceed tax revenues. Transfer payments are not included in GDP as they are not payments for goods or services, but they are part of government spending that must be financed. When tax revenues fall short of covering both government purchases and transfer payments, a deficit results.',
          },
        ],
      } as QuizContent,
    ],
...
Economic growth is the increase in real GDP over time. Growth comes from increases in quantity/quality of resources, technology, and productivity. Long-run growth (trend) differs from short-run fluctuations (business cycle). Growth improves living standards but must be balanced with environmental and social concerns. Sustainable growth considers economic, environmental, and social factors.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-5-6-1',
            question: 'If all factors of production besides labor are held constant, then what happens in an economy if output increases?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'If all factors of production besides labor are held constant (capital, technology, natural resources remain unchanged), and output increases, then employment must increase. This is because the only way to produce more output when other factors are fixed is to use more labor. More workers are needed to produce the additional output when capital, technology, and other factors cannot change.',
          },
          {
            id: 'quiz-5-6-2',
            question: 'Which of the following best describes what leads to an increase in labor productivity?',
            options: [
              'An equal increase in capital and workers',
              'An equal increase in technology and workers',
              'More workers',
              'More output per worker',
              'More education per worker',
            ],
            correctAnswer: 4,
            explanation: 'More education per worker leads to an increase in labor productivity. Education increases human capital, which enhances workers\' skills, knowledge, and ability to produce more output per hour worked. While more capital per worker and better technology also increase productivity, education directly improves the quality of the labor input itself. Simply having more workers (option C) increases total output but not necessarily output per worker. Option D describes productivity itself, not what leads to it.',
          },
          {
            id: 'quiz-5-6-3',
            ...
            options: [
              ...
              'any increase in nominal GDP per capita.',
              'any amount of inflation.',
              'an increase in real GDP.',
              'a sustained increase in real GDP per capita over time.',
            ],
            correctAnswer: 4,
            explanation: 'Economic growth is best defined as a sustained increase in real GDP per capita over time. This definition captures the key aspects of economic growth: it must be sustained (not just a temporary fluctuation), it must be in real terms (adjusted for inflation, not nominal), and it should be measured per capita (to account for population changes). Simply increasing nominal GDP could be due to inflation, and a one-time increase in real GDP doesn\'t necessarily represent growth if it\'s not sustained.',
          },
          {
            id: 'quiz-5-6-4',
            question: 'Which of the following is NOT a determinant of productivity?',
            options: [
              'Each worker\'s level of education',
            ...
            correctAnswer: 2,
            explanation: 'The stock of labor (the total number of workers) is NOT a determinant of productivity. Productivity is defined as output per worker, which measures how efficiently each worker produces. While the total stock of labor affects total output, it does not determine how much each individual worker can produce. The determinants of productivity are factors that affect output per worker: education (human capital), physical capital per worker, technology, and human capital per worker all directly influence how much each worker can produce.',
          },
        ],
      } as QuizContent,
    ],
...
The balance of payments records all international transactions. Current account includes trade, income, and transfers. Capital account includes investment flows. Current and capital accounts must net to zero (accounting identity). A current account deficit must be financed by a capital account surplus. Countries with trade surpluses accumulate foreign assets.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-6-1-1',
            question: 'Which of the following would NOT be included in the current account of Wakanda?',
            options: [
              'Exports from Wakanda to the nation of Theopolis',
              'Imports to Wakanda from Hamsterville',
              'Remittances from workers in Wizbaland sent back to family members in Wakanda',
              'Factor income earned by citizens of Wakanda on real assets held in the nation of Housego',
              'The nation of Maxistan buys a bond from Wakanda',
            ],
            correctAnswer: 4,
            explanation: 'The purchase of a bond by the nation of Maxistan from Wakanda would NOT be included in the current account. This transaction is a financial transaction (purchase of a financial asset) and belongs in the financial account, not the current account. The current account includes: exports and imports of goods and services (options A and B), remittances (option C), and factor income (option D). Financial transactions like bond purchases are recorded in the financial account.',
          },
          {
            id: 'quiz-6-1-2',
            question: 'If a country has a trade deficit, which of the following must also be true?',
            options: [
              'More funds are moving out of the country than are moving into a country',
              'It has a current account surplus',
              'Its exports exceed its imports',
              'It has a financial account surplus',
              'More funds are moving into the country than are moving out of the country',
            ],
            correctAnswer: 4,
            explanation: 'If a country has a trade deficit (imports exceed exports), more funds must be moving into the country than are moving out. A trade deficit means the country is spending more on imports than it earns from exports, creating a net outflow of funds for goods and services. According to the balance of payments identity, this current account deficit must be offset by a financial account surplus, which means there is a net inflow of capital - more funds are moving into the country (through foreign investment, borrowing, etc.) than are moving out. This capital inflow finances the trade deficit.',
          },
          {
            id: 'quiz-6-1-3',
            question: 'Mr. Frank is a citizen of Gatorland. He wants a better return on his savings than he gets in Gatorland, so he buys newly issued government bonds from the nation of Hamsterville. How is this purchase counted in the balance of payments in each country?',
            options: [
              'A debit in Gatorland\'s financial account; a credit in Hamsterville\'s financial account.',
              'A debit in Gatorland\'s current account; a credit in Hamsterville\'s current account.',
              'A credit in Gatorland\'s financial account; a debit in Hamsterville\'s financial account.',
              'No impact on Gatorland\'s balance of payments; a credit in Hamsterville\'s current account.',
            ],
            correctAnswer: 0,
            explanation: 'When Mr. Frank (a citizen of Gatorland) buys bonds from Hamsterville, this is recorded as a debit in Gatorland\'s financial account (outflow of capital - Gatorland is investing abroad) and a credit in Hamsterville\'s financial account (inflow of capital - foreign investment coming into Hamsterville). Bond purchases are financial transactions, not current account transactions, so they belong in the financial account. A debit represents an outflow of funds, and a credit represents an inflow of funds.',
          },
          {
            id: 'quiz-6-1-4',
            question: 'Which of the following describes something that would definitely be recorded as an increase in the current account?',
            options: [
            ...
            correctAnswer: 4,
            explanation: 'An increase in net exports would definitely be recorded as an increase in the current account. Net exports (exports minus imports) is a component of the current account. When net exports increase (either exports increase or imports decrease), the current account improves. A decrease in factor income earned abroad (option A) would decrease the current account. Selling bonds (options B and C) are financial transactions recorded in the financial account, not the current account. An increase in real GDP (option D) is a measure of economic output but is not directly recorded in the balance of payments.',
          },
        ],
      } as QuizContent,
    ],
...
Exchange rate is the price of one currency in terms of another. Currencies can appreciate (increase in value) or depreciate (decrease in value). Exchange rates can be fixed, floating, or managed. Supply and demand determine floating rates. Real exchange rates adjust for price levels and measure true competitiveness.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-6-2-1',
            question: 'The concepts of currency appreciation and depreciation are crucial for understanding fluctuations in exchange rates. Which of the following best describes an appreciated currency?',
            options: [
              'The depreciated currency can buy fewer domestic goods and services.',
              'The depreciated currency can buy more domestic goods and services.',
              'It takes more of another currency to buy that currency.',
              'The value of two currencies has equalized.',
              'It takes less of another currency to buy that currency.',
            ],
            correctAnswer: 2,
            explanation: 'An appreciated currency means its value has increased relative to other currencies. When a currency appreciates, it takes more units of another currency to purchase one unit of the appreciated currency. For example, if the US dollar appreciates against the euro, it might take 1.10 euros to buy 1 dollar instead of 0.90 euros. This is the opposite of depreciation, where it takes fewer units of another currency to buy the depreciated currency.',
          },
          {
            id: 'quiz-6-2-2',
            question: 'Which of the following is an exchange rate for the baht?',
            options: [
              '8 baht per cedi',
              '5 baht per krone',
              '0.2 baht per krone',
            ...
            correctAnswer: 3,
            explanation: 'An exchange rate for the baht (Thai baht) expresses how much of another currency equals one baht. "0.125 cedi per baht" means that 1 Thai baht equals 0.125 Ghana cedi. This is the correct format for expressing an exchange rate for the baht - it shows the quantity of another currency (cedi) per unit of baht. The other options either express rates for other currencies or are incomplete.',
          },
          {
            id: 'quiz-6-2-3',
            question: 'Bill is traveling to Russia from New Zealand. The currency of New Zealand is the dollar, and the currency of Russia is the ruble. If Bill hears that the New Zealand dollar has depreciated against the Russian ruble, which of the following best describes the impact the depreciation has on his trip?',
            options: [
              'The number of dollars it takes to buy a ruble is smaller than the number of rubles it takes to buy a dollar.',
              'His purchasing power has increased.',
              'His purchasing power has decreased.',
              'The value of the dollar and the ruble are now equal to each other.',
              'The number of dollars it takes to buy a ruble is higher than the number of rubles it takes to buy a dollar.',
            ],
            correctAnswer: 2,
            explanation: 'If the New Zealand dollar has depreciated against the Russian ruble, Bill\'s purchasing power has decreased. When a currency depreciates, it takes more units of that currency to buy one unit of the other currency. So Bill will need more New Zealand dollars to buy the same amount of Russian rubles, meaning his dollars can buy fewer rubles and thus fewer goods and services in Russia. His purchasing power in Russia has decreased because each dollar is worth less in terms of rubles.',
          },
          {
            id: 'quiz-6-2-4',
            question: 'The currency of Ghana is the cedi and the currency of Aruba is the florin. Which of the following best defines the exchange rate for the Aruban florin?',
            options: [
              'the quantity of florin per cedi',
              'the quantity of cedi needed',
              'the quantity of cedi per florin',
              'the quantity of florin needed to exchange for goods',
              'the number of cedi needed to exchange for goods',
            ],
            correctAnswer: 2,
            explanation: 'The exchange rate for the Aruban florin is best defined as "the quantity of cedi per florin." An exchange rate for a currency expresses how much of another currency equals one unit of that currency. So the exchange rate for the florin tells us how many cedis (Ghana\'s currency) are needed to buy one florin (Aruba\'s currency). This is the standard way to express an exchange rate: units of foreign currency per unit of domestic currency.',
          },
        ],
      } as QuizContent,
    ],
...
The forex market is where currencies are traded. Supply and demand determine exchange rates. Central banks can use reserves to influence rates. Speculative attacks can force currency devaluation. Fixed exchange rates require sufficient reserves and credible policy. The Thai crisis showed the vulnerability of fixed rates without strong fundamentals.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-6-3-1',
            question: 'How would Japan react to a depreciation of its own currency (the yen)?',
            options: [
              'It would buy more foreign financial assets',
              'The quantity of yen supplied would decrease',
              'It would demand more of other currencies',
              'The quantity of yen supplied would increase',
              'It would not react to a change in the value of the currency',
            ],
            correctAnswer: 1,
            explanation: 'When the yen depreciates, the quantity of yen supplied would decrease. A depreciation of the yen makes foreign goods, services, and assets more expensive for Japanese residents (it takes more yen to buy the same amount of foreign currency). As a result, Japanese residents reduce their demand for foreign items. To purchase foreign goods or assets, Japanese residents must supply yen to the foreign exchange market to acquire foreign currency. Since the demand for foreign items decreases, the quantity of yen supplied to the foreign exchange market also decreases.',
          },
          {
            id: 'quiz-6-3-2',
            question: 'Which of the following best describes appreciation of a currency?',
            options: [
              'The domestic purchasing power of that currency has increased',
              'It takes more of another currency to purchase that currency',
              'More of that currency is needed to buy foreign goods',
              'The domestic purchasing power of that currency has decreased',
              'It takes less of another currency to purchase that currency',
            ],
            correctAnswer: 1,
            explanation: 'Currency appreciation is best described as: it takes more of another currency to purchase that currency. When a currency appreciates, its value increases relative to other currencies. This means that one unit of the appreciated currency can buy more units of other currencies, or equivalently, it takes more units of other currencies to buy one unit of the appreciated currency. For example, if the dollar appreciates against the euro, it might take 1.10 euros to buy 1 dollar instead of 0.90 euros.',
          },
          {
            id: 'quiz-6-3-3',
            question: 'Which of the following best describes what an exchange rate is in the foreign exchange market?',
            options: [
              'The interest rate',
              'How much of one currency it takes to buy another currency',
              'The purchasing power of a currency domestically',
              'The quantity of goods and services a currency can buy in other countries',
              'The ratio of how much goods cost in one country relative to another country',
            ],
            correctAnswer: 1,
            explanation: 'An exchange rate in the foreign exchange market is best described as: how much of one currency it takes to buy another currency. The exchange rate is the price of one currency expressed in terms of another currency. For example, if the exchange rate is 1.20 USD per EUR, it means it takes 1.20 US dollars to buy 1 euro. This is the fundamental definition of an exchange rate in the foreign exchange market.',
          },
          {
            id: 'quiz-6-3-4',
            question: 'The real interest rate in Hamsterville is higher than the real interest rate in Gatorland. Frank is a resident of Gatorland and wants to take advantage of the higher return in Hamsterville by buying financial assets from Hamsterville. The currency of Hamsterville is the snark, and the currency of Gatorland is the percy. What effect will the increase in demand for Hamsterville\'s financial assets have on the market for the percy and the market for the snark?',
            options: [
              'There will be no change in the demand for the snark, and the supply of percies will increase.',
              'The demand for the snark and the supply of the percy will decrease.',
              'The demand for the snark will decrease, and the supply of the percy will increase.',
              'The demand for the snark and the supply of the percy will decrease.',
              'The demand for the snark increases and the supply of the percy increases.',
            ],
            correctAnswer: 4,
            explanation: 'When Frank (from Gatorland, using percy) wants to buy financial assets in Hamsterville (which are denominated in snark), he must exchange his percies for snarks. This action increases the demand for snarks (because Frank needs snarks to buy the assets) and increases the supply of percies (because Frank is selling percies to get snarks). In the foreign exchange market, when someone wants to buy assets denominated in a foreign currency, they increase the demand for that foreign currency and increase the supply of their own currency.',
          },
        ],
      } as QuizContent,
    ],
...
Many factors shift currency supply and demand. Higher interest rates, exports, and investment increase demand (appreciation). Higher imports, lower interest rates, and inflation increase supply (depreciation). Fiscal policy has mixed effects. Monetary policy clearly affects exchange rates through interest rates. Economic conditions like growth, inflation, and stability also matter.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-6-4-1',
            question: 'The euro is the currency of the European Union (E.U.). If the (E.U.) imposes a quota limiting imports from the United States, what will happen to the market for Euros and the exchange rate for the Euro?',
            options: [
              'Supply of the euro increases; the euro depreciates',
              'Supply of the euro increases; the euro appreciates',
              'Demand for euro decreases; euro depreciates',
              'Demand for euro increases; euro appreciates',
              'Supply of the euro decreases; the euro appreciates',
            ],
            correctAnswer: 1,
            explanation: 'When the EU imposes a quota limiting imports from the United States, the supply of the euro increases and the euro appreciates. A quota that limits imports reduces the quantity of imports, which means EU residents need fewer US dollars to purchase US goods. However, the quota may also affect expectations and capital flows. More importantly, when imports are restricted, the trade balance may improve, which can attract capital inflows as investors see better economic prospects. Additionally, with restricted imports, there may be increased demand for domestic goods and services, potentially affecting the overall demand for euros. The net effect is that the supply of euros increases (more euros available in the market) while the euro appreciates due to improved trade balance and potential capital inflows. The appreciation occurs despite the supply increase because the demand effects or other factors (like improved trade balance attracting investment) dominate.',
          },
          {
            id: 'quiz-6-4-2',
            question: 'Assuming there is no change in the nominal exchange rate, what will be the effect of contractionary monetary policy in Canada on the Canadian price level and the real exchange rate (RER) of the Canadian dollar?',
            options: [
              'Price level will decrease; RER will decrease.',
              'Price level will increase; RER will decrease.',
              'Price level will decrease; RER will remain unchanged.',
              'Price level will decrease; RER will increase.',
              'Price level will increase; RER will increase.',
            ],
            correctAnswer: 0,
            explanation: 'Contractionary monetary policy in Canada will decrease the price level and decrease the real exchange rate (RER). Contractionary monetary policy reduces the money supply, which decreases aggregate demand and leads to a lower price level. The real exchange rate (RER) is calculated as (Nominal Exchange Rate × Domestic Price Level) / Foreign Price Level. Since the nominal exchange rate is unchanged (given in the question) and the Canadian price level decreases, while the foreign price level is unchanged, the RER will decrease. A lower RER means the Canadian dollar is less expensive in real terms relative to foreign currencies.',
          },
          {
            id: 'quiz-6-4-3',
            question: 'The citizens of Burginland are convinced that there will never be an improvement in the economic situation there and that there are likely to be widespread defaults on bonds and bank failures. As a result, they want to buy more financial assets from their trading partner, Marthaland. The currency in Burginland is the eagle and the currency in Marthaland is the jean. What is the effect of the increased demand for Marthaland\'s financial assets on the real value of each country\'s currency?',
            options: [
              'The Burginland eagle depreciates and the Marthland jean appreciates.',
              'The Burginland eagle appreciates and the Marthland jean appreciates.',
              'The Burginland eagle appreciates and the Marthland jean is not affected.',
              'The Burginland eagle appreciates and the Marthland jean depreciates.',
              'The Burginland eagle is not affected and the Marthland jean appreciates.',
            ],
            correctAnswer: 0,
            explanation: 'When citizens of Burginland want to buy more financial assets from Marthaland, they need to exchange their eagles for jeans to purchase those assets. This increases the demand for the Marthland jean (because Burginland residents need jeans to buy the assets) and increases the supply of the Burginland eagle (because Burginland residents are selling eagles to get jeans). An increase in demand for the jean causes it to appreciate, while an increase in supply of the eagle causes it to depreciate. Therefore, the Burginland eagle depreciates and the Marthland jean appreciates.',
          },
        ],
      } as QuizContent,
    ],
...
Real interest rate differentials drive international capital flows. Higher real rates attract capital (appreciation). Lower real rates cause capital outflows (depreciation). Currency appreciation reduces net exports. Currency depreciation increases net exports. Monetary and fiscal policies affect exchange rates and thus trade balances. The impossible trinity limits policy options.`,
      ...
      } as ArticleContent,
      {
        ...
        questions: [
          {
            id: 'quiz-6-5-1',
            question: 'Maxistan and Ile are trading partners. Maxistan is currently experiencing a recession and, as a result, investors in Ile have less demand for Maxistan\'s financial assets. What will happen to the value of Ile\'s currency and the value of Ile\'s exports as a result of the decreased demand for foreign financial assets?',
            options: [
              'Ile\'s currency appreciates; exports from Ile decrease',
              'Ile\'s currency depreciates; Ile\'s exports decrease',
              'There is no impact on Ile\'s currency or exports',
              'Ile\'s currency appreciates; no impact on exports from Ile',
              'Ile\'s currency depreciates; Ile\'s exports increase',
            ],
            correctAnswer: 4,
            explanation: 'When investors in Ile have less demand for Maxistan\'s financial assets, they need less of Maxistan\'s currency to buy those assets. This means investors in Ile are supplying less of Ile\'s currency to get Maxistan\'s currency. Less supply of Ile\'s currency causes it to depreciate. When Ile\'s currency depreciates, Ile\'s goods become cheaper for foreign buyers (including Maxistan), which increases Ile\'s exports. Therefore, Ile\'s currency depreciates and Ile\'s exports increase.',
          },
          {
            id: 'quiz-6-5-2',
            question: 'The currency of Guatemala is the quetzal, and the currency in the eurozone is the euro. The current exchange rate is 10 quetzals per euro. What will happen to net exports and aggregate demand (AD) in the eurozone if the exchange rate changes to 5 quetzals per euro?',
            options: [
              'There will be no change in net exports or AD.',
              'Net exports and AD in the eurozone will decrease.',
              'Net exports and AD in the eurozone will decrease.',
              'Net exports in the euro zone will increase, and AD will be unaffected.',
              'Net exports and AD in the eurozone will increase.',
            ],
            correctAnswer: 4,
            explanation: 'When the exchange rate changes from 10 quetzals per euro to 5 quetzals per euro, the euro has depreciated relative to the quetzal (it takes fewer quetzals to buy one euro, meaning the euro is worth less). When the euro depreciates, eurozone goods become cheaper for buyers using quetzals, which increases eurozone exports. At the same time, goods from Guatemala become more expensive for eurozone buyers, which decreases eurozone imports. With exports increasing and imports decreasing, net exports (NX) increase. Since aggregate demand (AD = C + I + G + NX) includes net exports, an increase in NX leads to an increase in AD. Therefore, net exports and AD in the eurozone will increase.',
          },
          {
            id: 'quiz-6-5-3',
            question: 'What happens to the currency of Maxistan and aggregate demand in Maxistan if the demand for its financial assets decreases?',
            options: [
              'Currency depreciates; no impact on Maxistan\'s Aggregate demand (AD)',
              'Currency appreciates; aggregate demand (AD) increases',
              'Currency depreciates; aggregate demand (AD) increases',
              'Currency appreciates; no impact on Maxistan\'s Aggregate demand (AD)',
              'Currency depreciates; aggregate demand decreases',
            ],
            correctAnswer: 2,
            explanation: 'If the demand for Maxistan\'s financial assets decreases, foreign investors need less of Maxistan\'s currency to buy those assets. This reduces the demand for Maxistan\'s currency, causing it to depreciate. When Maxistan\'s currency depreciates, its goods become cheaper for foreign buyers, which increases exports. At the same time, foreign goods become more expensive for Maxistan\'s residents, which decreases imports. The increase in exports and decrease in imports increases net exports (NX). Since aggregate demand (AD = C + I + G + NX) includes net exports, an increase in NX leads to an increase in AD. Therefore, the currency depreciates and aggregate demand increases.',
          },
          {
            id: 'quiz-6-5-4',
            question: 'The initial exchange rate of the Guatemalan quetzal to the U.S. dollar is 10 quetzal per dollar. If the exchange rate changes to 5 quetzal per dollar, what happened to the value of the quetzal and what happens to Guatemala\'s exports?',
            options: [
              'The quetzal depreciated and its exports will increase.',
              'The quetzal appreciated and its exports will decrease.',
              'The quetzal appreciated and its exports will increase.',
              'The quetzal appreciated and its exports will increase.',
              'The quetzal depreciated and its exports are unaffected.',
            ],
            correctAnswer: 1,
            explanation: 'When the exchange rate changes from 10 quetzals per dollar to 5 quetzals per dollar, the quetzal has appreciated. Initially, it took 10 quetzals to buy 1 dollar. After the change, it takes only 5 quetzals to buy 1 dollar, meaning the quetzal is worth more (it takes fewer quetzals to buy the same dollar). When a currency appreciates, the country\'s goods become more expensive for foreign buyers. This makes Guatemala\'s exports less competitive, leading to a decrease in exports. Therefore, the quetzal appreciated and Guatemala\'s exports will decrease.',
          },
        ],
      } as QuizContent,
    ],
